...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("bikes", "6", "ALL BICYCLES", new string[0])]
        [NUnit.Framework.TestCaseAttribute("cars & trucks", "3", "ALL CARS & TRUCKS", new string[0])]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("0", "help", "CL Help Pages", new string[0])]
        [NUnit.Framework.TestCaseAttribute("1", "safety", "Avoiding Scams & Fraud", new string[0])]
        [NUnit.Framework.TestCaseAttribute("4", "cl jobs", "CL Jobs", new string[0])]
